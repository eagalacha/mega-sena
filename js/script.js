...
function removeNumberFromGame(numberToRemoove) {
  if (numberToRemoove < 1 || numberToRemoove > 60) {
    console.error("Número Inválido", numberToRemoove);
    return;
  }
  ...
  for (var i = 0; i < state.currentGame.length; i++) {
    ...
    if (currentNumber === numberToRemoove) {
      continue;
    }
